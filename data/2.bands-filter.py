...
# Defining Band-pass filter methods
...
# Decomposing frequency bands (Alpha, Beta, Delta, Theta, Gamma)
...
#  Data Visualization (creates fig. Brain wave decomposition)

'''
Note: As the order of the filter increases, the roll-off 
also decreases thus sharply cutting the stopband frequency, 
but more outstanding orders also introduce a lag in the 
filtered data. One can see the same by changing the order
in the above code to 1 as compared to the current value, i.e 3.
'''
